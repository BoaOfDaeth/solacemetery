  ...
  [Class.FIGHTER]: {
    ...
    specs: [
      ...
      },
      {
        ...
        skills: [
          { name: 'undercut', level: 19 },
          { name: 'bleed', level: 14 },
          { name: 'restrike', level: 24 },
        ],
      },
      {
      ...
      },
      {
        ...
        skills: [
          { name: 'boneshatter', level: 17 },
          { name: 'backhand', level: 15 },
          { name: 'drumming maces', level: 26 },
        ],
      },
      {
        id: FighterSpecialization.AXE,
        skills: [
          { name: 'pincer', level: 21 },
          { name: 'cleave', level: 26 },
          { name: 'chop', level: 14 },
          { name: 'concussion strike', level: 23 },
          { name: 'wrist chop', level: 26 },
          { name: 'meatgrinder', level: 28 },
        ],
      },
      {
