...
export const races: Record<Race, RaceData> = {
  [Race.HUMAN]: {
    ...
    features: ['Has +3 to the maximum of the primary characteristic'],
    bonusStat: 3,
    xpPenalty: 0,
  ...
  [Race.HALF_ELF]: {
    ...
    features: [
      'Has +2 to the maximum of the primary characteristic',
  ...
  [Race.KENDER]: {
    ...
    features: [
      'Can carve hoopaks from wood',
      'Have special skills when using a hoopak',
      'Learn stealing at expert level, if they are thieves',
      'Learn dodging at a decent level, if class allows',
      'Expert level with staff',
  ...
  [Race.HALF_KENDER]: {
    ...
    features: ['Has +1 to the maximum of the primary characteristic'],
    bonusStat: 1,
    xpPenalty: 10,
    allowedAlignments: [Alignment.GOOD, Alignment.NEUTRAL],
    maxStats: {
  ...
  [Race.MINOTAUR]: {
    ...
    features: [
      'Receive deathblow skill, if they are fighters',
  ...
  [Race.AURAK]: {
    ...
    features: [
      'Has a natural ability to regenerate health',
      'Expert level with enhanced damage, if class allows',
  ...
  [Race.BAAZ]: {
    ...
    features: [
      ...
      'Somehow has lower movement lag everywhere',
    ],
    xpPenalty: 20,
    allowedAlignments: [Alignment.EVIL],
    maxStats: {
